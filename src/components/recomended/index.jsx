...
export default function RowAndColumnSpacing() {
  return (
    <Box sx={{ width: '100%', backgroundColor: 'white', mt: '8%' }}>
      <Container>
        ...
        <Grid item xs={12} md={6} sm={6} lg={3}>
            <Item className='' sx={{ backgroundImage: `url(${'https://cdn.shopify.com/s/files/1/0026/0400/7539/products/3_550a7e04-0529-4e6f-b167-500522b5115c.png?v=1617537410'})`, backgroundSize: '100%', width: '100%', height: '350px' }}>
              ...
              <Typography className='pic'>
                <Typography className='text'>
                  ...
                  <img style={{ width: '100%', height: '100%' }} src="https://cdn.shopify.com/s/files/1/0026/0400/7539/products/3_2_dc07f2a7-6ee7-4b36-856b-0684866c10e2_263x.png?v=1617537410" alt="" />
          ...
          <Grid item xs={12} md={6} sm={6} lg={3}>
            <Item className='' sx={{ backgroundImage: `url(${'https://cdn.shopify.com/s/files/1/0026/0400/7539/products/5_3a5f8dbf-445a-45ad-9e1f-edc1a674e910.png?v=1617537244'})`, backgroundSize: '100%', width: '100%', height: '350px' }}>
              {/* <img src={index.img} alt='#'  style={{width:'100%',height:'100%'}} /> */}
              <Typography className='pic'>
                <Typography className='text'>
                  <Typography style={{ position: 'absolute', marginLeft: '18%' }}>❤</Typography>
                  <img style={{ width: '100%', height: '100%' }} src="https://cdn.shopify.com/s/files/1/0026/0400/7539/products/5_4_4d9ec1b9-56b8-4c9b-a398-9532742af244_263x.png?v=1617537255" alt="" />
                  {/* <Button variant="contained" sx={{borderRadius:'30px',bgcolor:'black',border:'1px solid black',marginTop:'130%'}}>Add Too Card</Button> */}
                </Typography>
                <Typography className='text2'>
                  <Button variant="contained" sx={{ bgcolor: 'blue', border: '1px solid black', marginTop: '60%' }}><LocalMallIcon style={{ fontSize: '120%' }} />Add Too Card</Button>
          ...
          <Grid item xs={12} md={6} sm={6} lg={3}>
            <Item className='' sx={{ backgroundImage: `url(${'https://cdn.shopify.com/s/files/1/0026/0400/7539/products/3_f386f1ab-cd7b-4acc-b899-e4c7e9e5166d.png?v=1617536654'})`, backgroundSize: '100%', width: '100%', height: '350px' }}>
              ...
              <Typography className='pic'>
                <Typography className='text'>
                  <Typography style={{ position: 'absolute', marginLeft: '18%' }}>❤</Typography>
                  <img style={{ width: '100%', height: '100%' }} src="https://cdn.shopify.com/s/files/1/0026/0400/7539/products/3_2_a2d3f1e0-609b-4562-b8d0-8d6fa1adad78_263x.png?v=1617536654" alt="" />
                  {/* <Button variant="contained" sx={{borderRadius:'30px',bgcolor:'black',border:'1px solid black',marginTop:'130%'}}>Add Too Card</Button> */}
                </Typography>
                <Typography className='text2'>
                  <Button variant="contained" sx={{ bgcolor: 'blue', border: '1px solid black', marginTop: '60%' }}><LocalMallIcon style={{ fontSize: '120%' }} />Add Too Card</Button>
          ...
          <Grid xs={12} md={6} sm={6} lg={3}>
            <Item className='' sx={{ backgroundImage: `url(${'https://cdn.shopify.com/s/files/1/0026/0400/7539/products/2_0b89f1a4-bdca-4df5-bdec-16e50a90af13.png?v=1617530321'})`, backgroundSize: '100%', width: '100%', height: '350px', marginTop: '3%', marginTop: '15%' }}>
              {/* <img src={index.img} alt='#'  style={{width:'100%',height:'100%'}} /> */}
              <Typography className='pic'>
                <Typography className='text'>
                  <Typography style={{ position: 'absolute', marginLeft: '18%' }}>❤</Typography>
          ...
          <Grid item xs={12} md={6} sm={6} lg={3}>
            <Item className='' sx={{ backgroundImage: `url(${'https://cdn.shopify.com/s/files/1/0026/0400/7539/products/5_661d25f0-e509-42a4-98f8-3b22fff0ed17.png?v=1617536870'})`, backgroundSize: '100%', width: '100%', height: '350px', marginTop: '10%' }}>
              {/* <img src={index.img} alt='#'  style={{width:'100%',height:'100%'}} /> */}
              <Typography className='pic'>
                <Typography className='text'>
                  <Typography style={{ position: 'absolute', marginLeft: '18%' }}>❤</Typography>
          ...
          <Grid item xs={12} md={6} sm={6} lg={3}>
            <Item className='' sx={{ backgroundImage: `url(${'https://cdn.shopify.com/s/files/1/0026/0400/7539/products/4_87c8f2f5-58f9-4066-870e-db783b16c4a2_medium.png?v=1617530481'})`, backgroundRepeat: 'no-repeat', backgroundSize: '100%', width: '100%', height: '350px', marginTop: '10%' }}>
              {/* <img src={index.img} alt='#'  style={{width:'100%',height:'100%'}} /> */}
              <Typography className='pic'>
                <Typography className='text'>
                  <Typography style={{ position: 'absolute', marginLeft: '18%' }}>❤</Typography>
